        ...
        else
        {
            ...
            for (int i = 63; i >= 0; i--)
            {
                ...
                if (rb[i] == 1)
                {
                    ...
                    else// agar 1 at indx 0. usko waisehi rhne dena h
                    {
                        kb2 = r;
                        ll z2 = kb2.to_ullong();
                ...
                else //agar 0 aaya to right k sare zero 
                {
                    kb2 = r;
                    kb2[i] = 0;
                    for (int j = i - 1; j >= 0; j--)
                    ...
                    ll ans2 = (x & z2) * (y & z2);// fn ki value at z2;
                    //cout<<"ans2 "<<ans2<<endl;
                    if (z2 <= r)
                    {
                        mp[z2] = ans2;
